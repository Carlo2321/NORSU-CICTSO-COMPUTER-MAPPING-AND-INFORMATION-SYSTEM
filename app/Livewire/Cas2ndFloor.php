...
class Cas2ndFloor extends Component
{
    public $floor;
    public $rooms;
    public $usedRoomIds = [];
    ...
    public function viewRoomCICTSO($roomId)
    {
    ...
    {
        return view('livewire.cas.cas2nd-floor');
    }
    ...
    public function goToLowerFloor()
    {
        ...
        $nextFloorId = 1; // Change this to the appropriate floor ID

        // Redirect to the route for the next floor with the floorId parameter
        return redirect()->route('cas1st-floor', ['floorId' => $nextFloorId]);
    }
