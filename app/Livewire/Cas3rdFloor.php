...
class Cas3rdFloor extends Component
{
    public $floor;
    public $rooms;
    public $usedRoomIds = [];
    ...
    public function viewRoomCSIT($roomId)
    {
    ...
    {
        return view('livewire.cas.cas3rd-floor');
    }
    ...
    public function goToLowerFloor()
    {
        ...
        $nextFloorId = 2; // Change this to the appropriate floor ID
    ...
    {
        // Assuming the next floor ID is known, you can hardcode it here
        $nextFloorId = 4; // Change this to the appropriate floor ID

        // Redirect to the route for the next floor with the floorId parameter
        return redirect()->route('cas4th-floor', ['floorId' => $nextFloorId]);
    }
