<div class="uiverse-container">
    <link href="{{ asset('css/cas4th.css?version=5') }}" rel="stylesheet">
    <div>
        <img style="width: 150%;" src="{{ asset('images/portplor.png') }}" alt="Floor Image">


        @foreach($rooms as $room)
        <div class="draggable-wrapper" data-id="{{ $room->id }}">
            <div class="tooltip-container">
                <button wire:click="viewRoomSkylab({{ $room->id }})" class="uiverse">{{ $room->roomName }}</button>
                <span class="tooltip">
